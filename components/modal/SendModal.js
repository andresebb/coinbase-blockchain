...
export const SendModal = ({
  ...
  //Get Coin Image
  useEffect(() => {
    setCoinImage(imageUrlBuilder(client).image(selectedToken.logo).url());
  }, [selectedToken]);
    ...
    <Wrapper>
      ...
      <TransferForm>
        ...
        <Row>
          ...
          <CoinSelected onClick={() => setAction("select")}>
            <Icon>
      ...
      <Row>
        <BalanceTitlte>{selectedToken.symbol} Balance</BalanceTitlte>
        <Balance>
          {balance}
...
const BalanceTitlte = styled.div``;
